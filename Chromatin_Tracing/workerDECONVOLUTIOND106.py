#conda activate cellpose2&&python D:\Carlos\Scripts\workerDECONVOLUTIOND106.py
#
######### Please add documentation
### This is experiemnt D106, we are analyzing the big tad to supplement the samll tad. Date started: 9/6/23 by Carlos
